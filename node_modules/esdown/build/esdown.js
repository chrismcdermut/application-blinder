...
var Nodes = __M(27, 1);
Object.keys(__M(27, 1)).forEach(function(k) { exports[k] = __M(27, 1)[k]; });
...
var isReservedWord = __M(24, 1).isReservedWord;
...
'use strict'; var isStrictReservedWord = __M(24, 1).isStrictReservedWord;
...
'use strict'; var AST = __M(23, 1);
var Scanner = __M(24, 1).Scanner;
var Transform = __M(25, 1).Transform;
var Validate = __M(26, 1).Validate;
...
var Parser = _esdown.class(function(__) { var Parser; __({ constructor: Parser = function() {} });
    ...
    addInvalidNode: function(error, node, strict) {
        ...
        node.error = error;
        this.context.invalidNodes.push({ node: node, strict: Boolean(strict) });
    },
...
var Replacer = _esdown.class(function(__) { var Replacer;
    ...
    BindNewExpression: function(node) {
...
var FS = __M(1, 1);
var isPackageSpecifier = __M(14, 1).isPackageSpecifier, isRelativePath = __M(14, 1).isRelativePath;
...
function runModule(path) {
    ...
    if (m && typeof m.main === "function") {
        ...
        var result$0 = m.main();
        Promise.resolve(result$0).then(null, function(x) { return setTimeout(function(_) { throw x }, 0); });
    }
}
        ...
        eval: function(input, context, filename, cb) { var __this = this; 
            ...
            if (result instanceof Promise) {
                ...
                Promise.race([
                    ...
                    result,
                    new Promise(function(a) { return setTimeout(function(_) { return a(token$0); }, 3000); }),
                ])
                .then(function(x) {
                ...
                .then(function(_) { return __this.displayPrompt(); });
...
var isLegacyScheme = __M(14, 1).isLegacyScheme,
    addLegacyScheme = __M(14, 1).addLegacyScheme,
    removeScheme = __M(14, 1).removeScheme,
    hasScheme = __M(14, 1).hasScheme,
    isNodeModule = __M(14, 1).isNodeModule,
    isPackageSpecifier = __M(14, 1).isPackageSpecifier;
...
var GraphBuilder = _esdown.class(function(__) { var GraphBuilder;
    ...
    __({ constructor: GraphBuilder = function(root, allowBrokenLinks) {
...
function bundle(rootPath, options) { if (options === void 0) options = {}; 
    ...
    var builder = new GraphBuilder(rootPath, options.allowBrokenLinks),
        visited = new Set,
        pending = 0,
        resolver,
        allFetched;
    ...
    new ConsoleCommand({
        ...
        execute: function(params) {
            ...
            promise.then(function(text) {
                ...
                setTimeout(function(_) { throw x }, 0);
            });
        }
